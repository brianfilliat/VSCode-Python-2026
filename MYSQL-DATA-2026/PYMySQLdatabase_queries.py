...
# This script demonstrates basic SQL queries using MySQL for two databases: db1 and db2

# Connect to db1 (users database)
conn1 = pymysql.connect(host='localhost', user='root', password='$Time9fly')
...
cursor1.execute("INSERT IGNORE INTO users (name, age) VALUES ('Alice', 25)")
cursor1.execute("INSERT IGNORE INTO users (name, age) VALUES ('Bob', 30)")
cursor1.execute("INSERT IGNORE INTO users (name, age) VALUES ('Charlie', 35)")
conn1.commit()
...
conn2 = pymysql.connect(host='localhost', user='root', password='$Time9fly')
...
cursor2.execute("INSERT IGNORE INTO products (name, price) VALUES ('Apple', 1.50)")
cursor2.execute("INSERT IGNORE INTO products (name, price) VALUES ('Banana', 0.75)")
cursor2.execute("INSERT IGNORE INTO products (name, price) VALUES ('Orange', 2.00)")
conn2.commit()
...
conn3 = pymysql.connect(host='localhost', user='root', password='$Time9fly')
cursor3 = conn3.cursor()
cursor3.execute("CREATE DATABASE IF NOT EXISTS db3")
conn3.select_db('db3')
...
cursor3.execute("INSERT IGNORE INTO applicants (id, email) VALUES (1, 'rastlattO@instagram.com')")
cursor3.execute("INSERT IGNORE INTO applicants (id, email) VALUES (2, 'gcarmodyl@stanford.edu')")
cursor3.execute("INSERT IGNORE INTO applicants (id, email) VALUES (3, 'mgreenset2@state.tx.us')")

# Insert sample data into appointments
cursor3.execute("INSERT IGNORE INTO appointments (applicant_id, dt) VALUES (1, '2024-05-26 01:36:43')")
cursor3.execute("INSERT IGNORE INTO appointments (applicant_id, dt) VALUES (2, '2024-05-26 16:30:28')")
cursor3.execute("INSERT IGNORE INTO appointments (applicant_id, dt) VALUES (3, '2024-05-18 19:28:52')")
conn3.commit()
...
cursor3.execute("""
SELECT a.email, DAYNAME(ap.dt) AS scheduled_appointment
FROM applicants a
