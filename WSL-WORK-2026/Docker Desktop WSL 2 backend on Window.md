...
- At a minimum WSL version 2.1.5, but ideally the latest version of WSL to [avoid Docker Desktop not working as expected](/desktop/features/wsl/best-practices/).
...
- [Understand how to develop with Docker and WSL 2](/desktop/features/wsl/use-wsl/)
- [Learn about GPU support with WSL 2](/desktop/features/gpu/)
- [Custom kernels on WSL](/desktop/features/wsl/custom-kernels/)
